...
import { PhotoIcon, XMarkIcon, ExclamationTriangleIcon, ArrowsUpDownIcon, StarIcon as StarIconOutline, DocumentIcon } from '@heroicons/react/24/outline'
        ...
        <form onSubmit={handleSubmit} className="space-y-8 p-6">
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 mb-4">
                {selectedFiles.map((file, index) => (
                  <div key={file.id} className="relative group">
                    <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute top-2 right-2 flex gap-2">
                        <button
                          ...
                          className="p-1.5 rounded-full bg-white/80 backdrop-blur-sm transition-opacity"
                      ...
                      <div className="absolute bottom-2 right-2 flex gap-2">
                        {index > 0 && (
                          <button
                            ...
                            className="p-1.5 rounded-full bg-white/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity"
                    ...
                    {file.isMain && (
                      <div className="absolute -top-2 -left-2 px-2 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-md">
                        Главное
                      </div>
                    )}
                  </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  {formData.cadastral_numbers.map((number, index) => (
                    <div key={index} className="flex gap-2">
                      <input
                        ...
                        className="block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm"
              ...
              <div>
                <label htmlFor="specified_area" className="block text-sm font-medium text-gray-700">
              ...
              <div>
                <label htmlFor="land_category" className="block text-sm font-medium text-gray-700">
                  Категория земель
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="permitted_use" className="block text-sm font-medium text-gray-700">
