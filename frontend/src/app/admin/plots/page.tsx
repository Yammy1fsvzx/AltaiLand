    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        <StatsCard
          ...
          value={totalPlots}
          icon={<Square2StackIcon className="h-6 w-6 text-green-600" />}
        />
        <StatsCard
          title="Свободно"
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-4 py-5 sm:px-6 flex flex-wrap gap-4 items-center justify-between">
          ...
          {plots.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
              {plots.map((plot) => (
                <div
                  key={plot.id}
                  className="bg-white border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col h-[400px] relative overflow-hidden"
                >
                  {/* Изображение */}
                  ...
                  <div className="flex flex-col flex-grow p-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-gray-50 rounded-lg p-2">
                        ...
                        <div className="font-medium text-gray-900">{plot.area} м²</div>
                        {plot.specified_area && (
                      ...
                      <div className="bg-gray-50 rounded-lg p-2">
                        ...
                        <div className="font-medium text-gray-900">{formatNumber(plot.price)} ₽</div>
                        <div className="text-xs text-gray-500">
